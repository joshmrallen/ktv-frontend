...
const NavBar = (props) => {
    ...
    return(
        <div className='box nav'>
            ...
            {/* {props.roomId ?  : null} */}
            {props.roomId && props.user ? <NavLink className="link" activeClassName="activeLink" to="/room">Room</NavLink> : props.user ?  <NavLink className="link" activeClassName="activeLink" to="/search">Search for Songs</NavLink> : <span className='link'>Please Log In to Search And Sing</span> }
